...
import RelatedProduct from "./RelatedServices";
  ...
  return (
    <>
      ...
      <div className="w-8/12 mx-auto">
        <h1 className="text-center text-4xl font-bold p-3">Other Services</h1>
